...
/**
 * This is the item provider adapter for a {@link SistemaEncuestas.Inicio} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InicioItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inicio_titulo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inicio_titulo_feature", "_UI_Inicio_type"),
				 SistemaEncuestasPackage.Literals.INICIO__TITULO,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Inicio)object).getTitulo();
